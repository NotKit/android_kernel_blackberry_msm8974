...
/* 8930 Phase 1 */
static struct platform_device msm8930_device_ext_5v_vreg data = {
...
static struct platform_device msm8930_device_ext_l2_vreg data = {
	.name	= GPIO_REGULATOR_DEV_NAME,
	.id	= 91,
	.dev	= {
...
static struct platform_device msm8930_device_ext_otg_sw_vreg data = {
	.name	= GPIO_REGULATOR_DEV_NAME,
	.id	= 97,
	.dev	= {
		.platform_data = &msm8930_pm8038_gpio_regulator_pdata[
...
static struct platform_device msm8930_device_rpm_regulator data = {
	.name	= "rpm-regulator",
	.id	= -1,
	.dev	= {
#ifndef MSM8930_PHASE_2

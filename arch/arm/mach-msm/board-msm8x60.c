...
/* GPIO regulator */
static struct platform_device msm8x60_8901_mpp_vreg data = {
...
#ifdef CONFIG_MSM_SSBI
static struct msm_ssbi_platform_data msm8x60_ssbi_pm8058_pdata data = {
...
static struct msm_ssbi_platform_data msm8x60_ssbi_pm8901_pdata data = {
	.controller_type = MSM_SBI_CTRL_PMIC_ARBITER,
	.slave	= {
		.name = "pm8901-core",

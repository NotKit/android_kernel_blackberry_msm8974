...
static struct pm8018_platform_data pm8018_platform_data data = {
...
static struct msm_ssbi_platform_data msm9615_ssbi_pm8018_pdata data = {
...
static struct platform_device msm9615_device_rpm_regulator data = {
	.name	= "rpm-regulator",
	.id	= -1,
	.dev	= {

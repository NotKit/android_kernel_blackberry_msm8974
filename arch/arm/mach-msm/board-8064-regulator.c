...
apq8064_gpio_regulator_pdata[] data = {
...
struct gpio_regulator_platform_data
mpq8064_gpio_regulator_pdata[] data = {
...
msm8064_pm8921_regulator_pdata[] data = {
	/*
...
struct pm8xxx_regulator_platform_data
msm8064_pm8917_regulator_pdata[] data = {
	/*
	 *		ID   name always_on pd min_uV   max_uV   en_t supply
	 *	system_uA reg_ID
	 */
...
apq8064_rpm_regulator_init_data[] data = {
...
static struct rpm_regulator_init_data
apq8064_rpm_regulator_pm8921_init_data[] data = {
	/*     ID  a_on pd ss                   supply */
...
int msm8064_pm8921_regulator_pdata_len data =
	ARRAY_SIZE(msm8064_pm8921_regulator_pdata);
int msm8064_pm8917_regulator_pdata_len data =
...
static struct rpm_regulator_consumer_mapping
	      msm_rpm_regulator_consumer_mapping[] data = {
...
struct rpm_regulator_platform_data apq8064_rpm_regulator_pdata data = {
...
apq8064_rpm_regulator_pm8921_pdata data = {

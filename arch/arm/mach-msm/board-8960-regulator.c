...
struct gpio_regulator_platform_data msm_gpio_regulator_pdata[] data = {
...
msm_rpm_regulator_init_data[] data = {
...
int msm_pm8921_regulator_pdata_len data =
...
struct rpm_regulator_platform_data msm_rpm_regulator_pdata data = {

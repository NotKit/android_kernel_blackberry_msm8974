...
static struct pm8xxx_irq_platform_data pm8xxx_irq_pdata data = {
	.irq_base		= PM8038_IRQ_BASE,
	.devirq			= MSM_GPIO_TO_INT(104),
	.irq_trigger_flag	= IRQF_TRIGGER_LOW,
};

static struct pm8xxx_gpio_platform_data pm8xxx_gpio_pdata data = {
	.gpio_base	= PM8038_GPIO_PM_TO_SYS(1),
};

static struct pm8xxx_mpp_platform_data pm8xxx_mpp_pdata data = {
	.mpp_base	= PM8038_MPP_PM_TO_SYS(1),
};

static struct pm8xxx_rtc_platform_data pm8xxx_rtc_pdata data = {
...
static struct pm8921_charger_platform_data pm8921_chg_pdata data = {
	.update_time		= 60000,
...
static struct pm8921_bms_platform_data pm8921_bms_pdata data = {
...
static struct pm8038_platform_data pm8038_platform_data data = {
...
static struct msm_ssbi_platform_data msm8930_ssbi_pm8038_pdata data = {
...
static struct pm8921_platform_data pm8917_platform_data data = {
	.irq_pdata		= &pm8xxx_irq_pdata,
	.gpio_pdata		= &pm8xxx_gpio_pdata,
	.mpp_pdata		= &pm8xxx_mpp_pdata,
	.rtc_pdata              = &pm8xxx_rtc_pdata,
...
static struct msm_ssbi_platform_data msm8930_ssbi_pm8917_pdata data = {
	.controller_type = MSM_SBI_CTRL_PMIC_ARBITER,
	.slave	= {
		.name			= "pm8921-core",

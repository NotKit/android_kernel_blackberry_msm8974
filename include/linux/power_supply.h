...
enum {
	...
	POWER_SUPPLY_DP_DM_DPF_DMF = 6,
	POWER_SUPPLY_DP_DM_DPR_DMR = 7,
	POWER_SUPPLY_DP_DM_HVDCP3_SUPPORTED = 8,
	POWER_SUPPLY_DP_DM_ICL_DOWN = 9,
	POWER_SUPPLY_DP_DM_ICL_UP = 10,
	POWER_SUPPLY_DP_DM_FORCE_5V = 11,
	POWER_SUPPLY_DP_DM_FORCE_9V = 12,
	POWER_SUPPLY_DP_DM_FORCE_12V = 13,
};
...
enum power_supply_type {
	...
	POWER_SUPPLY_TYPE_USB_HVDCP_3P5, /* Efficient High Voltage DCP 3.5 */

...
#define NFC_RAW_HEADER_SIZE 1

#define NFC_DIRECTION_RX 0
#define NFC_DIRECTION_TX 1

#define RAW_PAYLOAD_LLCP 0
#define RAW_PAYLOAD_NCI 1
#define RAW_PAYLOAD_HCI 2
#define RAW_PAYLOAD_ISO14443 3
